                ...
                if ( (field_num = FLAC__metadata_object_vorbiscomment_find_entry_from(block,0,"TRACKTOTAL")) >= 0 )
                {
                    ...
                    if (field_value)
                    {
                        ...
                        if ( field_value && g_utf8_strlen(field_value, -1) > 0 )
                        {
                            ...
                            FileTag->track_total = et_format_track_number(atoi(field_value));
                            g_free(field_value);
                        }
                    }
                ...
                if ( (field_num = FLAC__metadata_object_vorbiscomment_find_entry_from(block,0,"TRACKNUMBER")) >= 0 )
                {
                    ...
                    if (field_value)
                    {
                        ...
                        if ( field_value && g_utf8_strlen(field_value, -1) > 0 )
                        {
                            ...
                            {
                                FileTag->track_total = et_format_track_number(atoi(string+1));
                                *string = '\0';
                            }
                            FileTag->track = et_format_track_number(atoi(field_value));
